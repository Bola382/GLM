...
modelo = MASS::glm.nb(incidents ~ ., data = dados.input, maxit = 300)
...
# Quantilicos
qRes = sapply(1:(nrow(dados)), function(a) qnorm(pnbinom(dados.input$incidents[a], mu = fitted(modelo)[a], size = modelo$theta)))
